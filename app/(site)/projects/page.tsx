...
const projects: {
...
}[] = [
  {
    ...
    cat: "Full Stack",
    filter: "Full Stack",
    desc: "Award-winning platform to digitise and streamline mining operations in Sri Lanka. Features an AI-powered chatbot, interactive mine maps, and digital permit application workflows. 2nd Runners-up at Cutting Edge 2025 with GSMB endorsement.",
  ...
  },
  {
    ...
    cat: "Open Source",
    filter: "Open Source",
    desc: "Free, open-source software development roadmaps built for Sri Lankan learners. Provides structured learning paths from beginner fundamentals to production-ready skills.",
  ...
  },
  {
    ...
    cat: "Full Stack",
    filter: "Full Stack",
    desc: "Full-featured ticket management system with user authentication, OOP design patterns, and a responsive React front-end backed by a Spring Boot REST API.",
            ...
            <AnimatePresence mode="popLayout">
              {list.map((p) => (
                <motion.article
                  ...
                  className="card-hover flex flex-col overflow-hidden rounded-2xl border shadow-sm"
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col p-5">
                    ...
                    <p className="mt-2 flex-1 text-sm leading-relaxed" style={{ color: "var(--muted-fg)" }}>{p.desc}</p>
